...
let () =
  let view = Hizkuntzak_app.register_service ["eus"] Eliom_parameter.unit Games.service in
  let main_service =
  ...
  Hizkuntzak_app.register
    ...
    (fun () () ->
      let links = ul [li ~a:[a_class ["active"]] [a ~service:view [pcdata "Games on basque language"] ()]] in
      Lwt.return
        (Eliom_tools.F.html
           ~title:"hizkuntzak"
